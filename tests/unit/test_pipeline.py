...
from warp.catalog.models import DatabaseCatalog, LocalizedText, TableCatalogEntry
from warp.config.settings import Settings
from warp.core.exceptions import AutoCrudException
from warp.integration.pipeline import Pipeline, PipelineResult
...
async def test_pipeline_db_config_not_found(tmp_path: Path) -> None:
    ...
    with pytest.raises(AutoCrudException, match="config not found"):
